...
<details> 
  ...
  Кэш можно сделать массивом объектов. Тогда внутри `wrapper` следует проверять, если ли `hash(args)` в кэше и если нет, то удалять первый элемент и вставлять в конец новый.
